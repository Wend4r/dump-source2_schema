...
public:
	...
	float m_flLandedFlatGroundFrictionGraceTime; // 0x158c	
	...
	float m_flSlideActivationProbeForwardOffset; // 0x1604	
	// MPropertyDescription "Maximum distance between probe samples"
	float m_flMaxDistanceBetweenProbeSamples; // 0x1608	
