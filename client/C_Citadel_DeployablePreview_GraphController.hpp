...
public:
	...
	static bool &Get_s_bSchemaTest(){return *reinterpret_cast<bool*>(interfaces::g_schema->FindTypeScopeForModule("client.dll")->FindDeclaredClass("C_Citadel_DeployablePreview_GraphController")->m_static_fields[1]->m_instance);};
};
