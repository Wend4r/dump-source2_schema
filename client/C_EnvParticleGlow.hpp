...
public:
	// MNetworkEnable
	float m_flAlphaScale; // 0xe10	
	// MNetworkEnable
	float m_flRadiusScale; // 0xe14	
	// MNetworkEnable
	float m_flSelfIllumScale; // 0xe18	
	// MNetworkEnable
	Color m_ColorTint; // 0xe1c	
	// MNetworkEnable
	CStrongHandle< InfoForResourceTypeCTextureBase > m_hTextureOverride; // 0xe20	
