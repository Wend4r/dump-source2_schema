...
public:
	...
	CNetworkUtlVectorBase< CHandle< CBasePlayerController > > m_aPlayerControllers; // 0x4e8	
	// MNetworkEnable
	// MNetworkAlias "m_aPawns"
	CNetworkUtlVectorBase< CHandle< CBasePlayerPawn > > m_aPlayers; // 0x500	
	// MNetworkEnable
	int32_t m_iScore; // 0x518	
	// MNetworkEnable
	char m_szTeamname[129]; // 0x51c	
};
