...
public:
	...
	static bool &Get_s_bLogFullChangeEntities(){return *reinterpret_cast<bool*>(interfaces::g_schema->FindTypeScopeForModule("server.dll")->FindDeclaredClass("CNetworkTransmitComponent")->m_static_fields[6]->m_instance);};
};
