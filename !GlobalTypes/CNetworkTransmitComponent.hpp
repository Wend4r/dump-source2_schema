...
public:
	...
	static bool &Get_s_bLogFullChangeEntities(){return *reinterpret_cast<bool*>(interfaces::g_schema->FindTypeScopeForModule("!GlobalTypes")->FindDeclaredClass("CNetworkTransmitComponent")->m_static_fields[6]->m_instance);};
};
